...
ad_proc -public qal_demo_address_write {
    ...
    ns_log Notice "qal_demo_address_write.589. contact_id '${contact_id}' instance_id '${instance_id}' array get arr '[array get a_arr]'"
    ns_log Notice "qal_demo_address_write.590. contact_id '$a_arr(contact_id)' instance_id '${instance_id} notes '$a_arr(notes)'"
